...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    pdv7AuthUserSubject.add(
      Pdv7AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Pdv7AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Pdv7AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Pdv7AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    pdv7AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
